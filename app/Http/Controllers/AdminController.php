...
class AdminController extends Controller
{
    ...
    public function order_incomplete()
    {
        ...
        $orders = DB::table('carts')->where('product_order', 'Order placed')
            ->groupBy('invoice_no')
            ->get();
    ...
    public function order_complete()
    {
        ...
        $orders = DB::table('carts')->where('product_order', 'delivered')
            ->groupBy('invoice_no')
            ->get();
    ...
    public function admin_show()
    {
        ...
        $admins = DB::table('users')->where('usertype', '2')->get();
    ...
    public function chef_add_process(Request $req)
    {
        ...
        $details = [
            ...
            'body' => 'Congrats ! You are selected as a  Chef  of Hotel_Century And You Are Selected by Hotel_Century Owner. Your Email ID - ' . $req->email . ' & Password - ' . $req->password,
        ];
    ...
    public function invoice_approve(Request $req, $id)
    {
        ...
        $details = [
            'title' => 'Mail from Hotel_Century',
            'body' => 'Your order approved by Hotel_Century.Your order Invoice no - ' . $id . ' & Delivery Time (approximately) - ' . $req->time,
        ];
        ...
        if ($status != "approve") {
            ...
            $details = [
                'title' => 'Mail from Hotel_Century',
                'body' => 'Your order approved by Hotel_Century.Your order Invoice no - ' . $id . ' & Delivery Remaining Time (approximately) - ' . $req->time,
            ];
    ...
    public function invoice_details($id)
    {
        ...
        // dd($date);
        return view('admin.invoice_details', compact('total_price', 'extra_charge', 'total_extra_charge', 'discount_price', 'wihout_discount_price', 'products', 'date',));
    }
    public function invoice_cancel($id)
    {
        ...
        if ($pay_method == "Online Payment") {
            ...
            $details = [
                'title' => 'Mail from Hotel_Century',
                'body' => 'Sorry Sir.Your order cancelled by Hotel_Century for inevitable reason.You will get your money back within 8 working days..Your order Invoice no - ' . $id,
            ];
        } else {
            ...
            $details = [
                'title' => 'Mail from Hotel_Century',
                'body' => 'Sorry Sir.Your order cancelled by Hotel_Century for inevitable reason.Your order Invoice no - ' . $id,
            ];
        }
        $user = DB::table('users')->where('id', $user_id)->first();
    ...
    public function invoice_complete($id)
    {
        ...
        $data['product_order'] = "delivered";


        $details = [
            'title' => 'Mail from Hotel_Century',
            'body' => 'Your order delivered by Hotel_Century.Your order Invoice no - ' . $id,
        ];
    ...
    public function add_admin_process(Request $req)
    {
        ...
        $details = [
            'title' => 'Mail from Hotel_Century',
            'body' => 'Congrats ! You are selected as a ' . $usertype . 'of Hotel_Century And Your  ( Salary - ' . $req->salary . ' RS ) Selected by Hotel_Century Owner. Your Email ID - ' . $req->email . ' & Password - ' . $req->password,
        ];
    ...
    public function delete_admin($id)
    {
        ...
        $details = [
            'title' => 'Mail from Hotel_Century',
            'body' => 'Sorry ! You have been fired from your job by Hotel_Century Panel.So, your account is deleted by Hotel_Century Panel.',
        ];
    ...
    public function edit_admin_process(Request $req, $id)
    {
        ...
        if ($update) {
            $details = [
                'title' => 'Mail from Hotel_Century',
                'body' => 'Congrats ! Your information is updated by Hotel_Century Panel.',
            ];
            ...
            if (($req->salary != NULL && $req->salary > $previous_salary) || ($req->type != NULL && $req->type < $previous_position)) {
                ...
                $details = [
                    'title' => 'Mail from Hotel_Century',
                    'body' => 'Congrats ! You are promoted for a ' . $usertype . ' position. ( Now, Your salary - ' . $req->salary . 'Tk ) of Hotel_Century by Hotel_Century Panel.',
                ];
                ...
                $details = [
                    'title' => 'Mail from Hotel_Century',
                    'body' => 'Sorry ! You are depromoted for a ' . $usertype . ' position. ( Now, Your salary - ' . $req->salary . 'Tk ) of Hotel_Century by Hotel_Century Panel.',
                ];
            }
    ...
    public function add_delivery_boy_process(Request $req)
    {
        ...
        $details = [
            'title' => 'Mail from Hotel_Century',
            'body' => 'Congrats ! You are selected as a Delivery Boy position of Hotel_Century  And Your  ( Salary - ' . $req->salary . 'Rs )  by  Hotel_Century  Owner. Your Email ID - ' . $req->email . ' & Password - ' . $req->password,
        ];
    ...
    public function edit_delivery_boy_process(Request $req, $id)
    {
        ...
        if ($update) {
            ...
            if (($req->salary != NULL && $req->salary > $previous_salary)) {
                ...
                $details = [
                    'title' => 'Mail from Hotel_Century',
                    'body' => 'Congrats ! You are promoted for a  Delivery Boy position. ( Now, Your salary - ' . $req->salary . 'Tk ) of Hotel_Century by Hotel_Century Panel.',
                ];
                ...
                $details = [
                    'title' => 'Mail from Hotel_Century',
                    'body' => 'Sorry ! You are depromoted for a  Delivery Boy position. ( Now, Your salary - ' . $req->salary . 'Tk ) of Hotel_Century by Hotel_Century Panel.',
                ];
            }
