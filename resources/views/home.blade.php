...
@section('page-content')
    <?php
    use Carbon\Carbon;
    $olddate = Carbon::today()->toDateString();
    $date = Carbon::createFromFormat('Y-m-d', $olddate)->format('m.d.Y');
    ?>
                    ...
                    <div class="left-content">
                        @if (Auth::user())
                            <div class="inner-content">
                                <h4>Hotel_Century</h4>
                                <h5>THE BEST EXPERIENCE</h5>
                                <div class="main-white-button scroll-to-section">
                                    <a href="#table_reservation">
                        ...
                        @if (!Auth::user())
                            <div class="inner-content">
                                <h4>Hotel_Century</h4><br>
                                <h5 style="color:greenyellow;">THE BEST EXPERIENCE</h5>
                                <div class="main-white-button scroll-to-section">
                                    <a href="{{ url('/login') }}">
                                        <h2>Make A Reservation</h2>
                                    </a>
                    ...
                    <div class="main-banner header-text">
                        <div class="Modern-Slider">
                            ...
                            @foreach ($banners as $banner)
                                ...
                                <div class="item">
                                    <div class="img-fill">
                                        <img class="p" src="{{ asset('assets/images/' . $banner->image) }}">
                                    </div>
                                </div>
                            @endforeach
                            <!-- // Item -->
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="right-content">
                        <iframe class="fa fa-play" width="510" height="250" src="{{ $a_us->youtube_link }}?autoplay=1">
                        </iframe>
                        @endforeach
                    </div>
                </div>
    ...
    <!-- ***** About Area Ends ***** -->
    <?php
    $special = DB::table('products')
        ->where('catagory', '=', 'special')
        ->count();
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 offset-lg-4 text-center">
                    <div class="section-heading">
                        <h6>Hotel_Century Week</h6>
                        <?php  if($special != 0) {?>
                        <h2>This Week’s Special Meal Offers</h2><?php }else{?>
                        <h2> Sorry ! This Week’s There is No Special Meal Offers</h2>
                        <?php }
?>
                    </div>
                </div>
            ...
            <div class="col-lg-12">
                <div class="owl-menu-item owl-carousel">
                    ...
                    @foreach ($menu as $product)
                        <div class="item" @if ($product->available != 'Stock') style="opacity:0.5;" @endif>
                            ...
                            <div class='card' style="background-image: url({{ asset('assets/images/' . $img) }})">
                                ...
                                ?>
                                <div class='info' @if ($product->available != 'Stock') style="display:none;" @endif>
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="left-text-content">
                        ...
                        <p>Members of Hotel_Century are always active to response your call.</p>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="phone">
                                    <i class="fa fa-phone"></i>
                                    <h4>Phone Numbers</h4>
                                    <span><a>+918645793256</a>
                                        <br><a>+919654236589</a>
                                    </span>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="message" id="table_reservation">
                                    <i class="fa fa-envelope"></i>
                                    <h4>Emails</h4>
                                    <span><a href="mailto:hotel.century01@gmail.com">hotel.century01@gmail.com</a><br>
                                        <a href="mailto:hotel.century01@gmail.com">hotel.century01@gmail.com</a><br>
                                    </span>
                                </div>
                            </div>
                        </div>
                            ...
                            <form id="contact" action="/reserve/confirm" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <fieldset>
                                            <span id="status" class="mb-4 font-medium text-sm text-red-600">
                                                <small>Confirm Time Before Submitting .</small></span>
                                    ...
                                    <div class="col-lg-12">
                                        <fieldset>
                                            ...
                                            <button type="submit" id="form-submit" class="main-button-icon">Make
                                                A
                                                Reservation</button>
