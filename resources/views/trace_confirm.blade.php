            ...
            @foreach ($carts as $product)
                ...
                <div class="row">
                    ...
                    <div class="column">
                        ...
                        @if ($product->product_order == 'approve' || $product->product_order == 'delivered')
                        ...
                        @if ($product->product_order == 'Order Placed')
                    ...
                    <div class="column">
                        ...
                        @if ($product->product_order == 'delivered')
                            <img src="{{ asset('assets/images/right.png') }}" style="margin-top:-15px !important;"
                                height="50px" weight="50px" alt="">
        ...
        <tbody>
            ...
            @foreach ($carts as $product)
                ...
                <tr>
                    ...
                    <td style="text-align:center">Rs:{{ $product->subtotal }}</td>
            ...
            @foreach ($extra_charge as $charge)
                ...
                <tr>
                    ...
                    <td style="text-align:center"></td>
                    <td style="text-align:center">Rs:{{ $charge->price }}</td>
        ...
        <tfoot>
            <tr>
                ...
                <td colspan="4" class="text-right">
                    <h6><strong>Total Rs:{{ $without_discount_price }}</strong></h6>
                </td>
            </tr>
            <tr>
                @php
                ...
                @endphp
                <td colspan="4" class="text-right">
                    <h6><strong>Discount Rs:{{ $discount_price }}</strong></h6>
                </td>
            </tr>
            <tr>
                @php
                ...
                @endphp
                <td colspan="4" class="text-right">
                    <h3><strong>Total (With Discount)Rs:{{ $total_price }}</h2></strong></h3>
                </td>
            </tr>
            <tr>
