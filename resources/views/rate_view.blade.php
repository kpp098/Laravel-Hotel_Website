            ...
            <td>
                ...
                <div id="rate" class="rate" style="margin-bottom:30px !important;margin-right:430px; !important">
                    ...
                    @for ($i = 1; $i <= $find_rate; $i++)
                        <label id="star{{ $i }}" onclick="rate({{ $i }})" style="color: #FCA311;"
                            class="active"></label>
                    @endfor
                ...
                <p></p>
                <p></p>
                <a href="/edit/rate/{{ $products->id }}" style="color:green;padding-top:50px !important;">,<b>Edit
                        Rating</b></a>

                <a href="/delete/rate/" style="color:red;margin-left:20px;padding-top:50px !important;"><b>Delete
                        Rating</b></a>
