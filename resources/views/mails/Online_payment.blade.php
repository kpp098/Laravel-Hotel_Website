            ...
            <table class="invoice-head" style="margin-left:20px;font-size:18px;">
                <tbody>
                    ...
                    <tr style="text-align:left">
                        ...
                        <td style="text-align:left">: {{ Session::get('transaction') }}</td>
                    </tr>
                ...
                <tbody>
                    @foreach ($products as $product)
                        <tr style="border:2px solid;">
                            ...
                            <td style="margin-left:20px;">Rs: {{ $product->subtotal }}</td>
                        </tr>
                    @endforeach
                    @foreach ($extra_charge as $charge)
                        <tr style="border:2px solid;">
                            ...
                            <td style="margin-left:20px;"></td>
                            <td style="margin-left:20px;">Rs: {{ $charge->price }}</td>
                        </tr>
                    @endforeach
                    <tr>
                        <td colspan="4"></td>
                    ...
                    <tr>
                        ...
                        <td><strong>Rs: {{ $without_discount_price }} </strong></td>
                    </tr>
                    <tr>
                        <td colspan="4"></td>
                    </tr>
                    <tr>
                        ...
                        <td><strong>Rs: {{ $discount_price }}</strong></td>
                    </tr>
                    <tr>
                        <td colspan="4"></td>
                    </tr>
