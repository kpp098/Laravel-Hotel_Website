    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                ...
                @if (Auth::user()->usertype == 2)
                    <a class="sidebar-brand brand-logo" href="/redirects"
                        style="color:white;text-decoration:none;">Delivery Boy
                        Panel</a>
                @endif
                ...
                @if (Auth::user()->usertype == 1)
                    ...
                    <li class="nav-item menu-items">
                        ...
                        <div class="collapse" id="ui-basic2">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="/admin/add/banner">Add
                                        Banners</a>
                                </li>
                                <li class="nav-item"> <a class="nav-link" href="/admin/banner/all">All
                                        Banners</a>
                                </li>
                            </ul>
                        </div>
