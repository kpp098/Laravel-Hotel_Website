...
@section('container')
    ...
    @foreach ($products as $product)
        ...
        <div class="card">
            <img class="card-img-top" src="{{ asset('assets/images/' . $product->image) }}" style="width:100%;height:280px;"
                alt="Card image cap">
            <div class="card-body">
                ...
                @endif
                <p style="text-transform:capitalize;">Price : {{ $product->price }} Rs</p>
                ...
                <span class="rating_avg">Rating : {{ $per_rate }}</span><br>

            </div>
            <div class="card-footer">
                <small class="text-muted"><a href="{{ asset('/menu/edit/' . $product->id) }}"
                        class="btn btn-primary">Edit</a>
                    <a href="{{ asset('/menu/delete/' . $product->id) }}" class="btn btn-danger"
