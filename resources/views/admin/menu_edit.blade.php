        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ asset('/menu/edit/process/' . $product->id) }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="catagory" id="exampleSelectGender">
                                <option value="regular" @php if($product->catagory=="regular"){ echo"selected"; } @endphp>
                                    Regular</option>
                                <option value="special" @php if($product->catagory=="special"){ echo"selected"; } @endphp>
                                    Special</option>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="session" id="exampleSelectGender">
                                <option value="0" @php if($product->session=="0"){ echo"selected"; } @endphp>Breakfast
                                </option>
                                <option value="1" @php if($product->session=="1"){ echo"selected"; } @endphp>Lunch
                                </option>
                                <option value="2" @php if($product->session=="2"){ echo"selected"; } @endphp>Dinner
                                </option>
                            </select>
                        </div>
